  ...
  const businessFeatures: Feature[] = [
    {
      ...
      description: 'One place to see cash flow, revenues, expenses, and account balances in real time — AI-powered dashboards tailored for founders and finance/Business heads.',
    ...
    },
    {
      ...
      description: 'Unlock benefits (Cashback on Saving and Credit offers) when you manage cash flow well or maintain strong reserves.',
      icon: 'Gift',
    ...
    },
    {
      ...
      description: 'Visualize exit strategies, profit goals, investor payouts, and long-term financial strategy.',
      icon: 'Eye',
